...
And than executing the executable:
    ...
    Input #0, image2, from '/viash_automount/home/rcannood/workspace/di/viash_workshop_1/030-ViashVersion/data/viash.png':
    ...
    Input #1, png_pipe, from '/viash_automount/home/rcannood/workspace/di/viash_workshop_1/030-ViashVersion/data/viash1.png':
      Duration: N/A, bitrate: N/A
        Stream #1:0: Video: png, gray(pc), 612x792 [SAR 72:72 DAR 17:22], 25 tbr, 25 tbn, 25 tbc
    Stream mapping:
      Stream #0:0 -> #0:0 (png (native) -> vp9 (libvpx-vp9))
    Press [q] to stop, [?] for help
    [libvpx-vp9 @ 0xc90300] v1.8.0
    ...
    frame=    1 fps=0.0 q=0.0 Lsize=      17kB time=00:00:00.00 bitrate=141496.0kbits/s speed=0.0052x    
