...
Running tests in temporary directory: '/tmp/viash_test_convert_plot1419468538707772100'
====================================================================
+/tmp/viash_test_convert_plot1419468538707772100/build_executable/convert_plot ---setup
> docker build -t civ6_save_renderer/convert_plot:1.0 --no-cache /tmp/viashsetupdocker-convert_plot-dsoJUP
...
Fetched 8420 kB in 3s (3151 kB/s)
...
Fetched 15.4 MB in 1s (17.5 MB/s)
...
Removing intermediate container 952fe8e05f45
 ---> 20e35454ceb7
Successfully built 20e35454ceb7
Successfully tagged civ6_save_renderer/convert_plot:1.0
====================================================================
+/tmp/viash_test_convert_plot1419468538707772100/test_run_test.sh/run_test.sh
...
Running tests in temporary directory: '/tmp/viash_test_combine_plots5052818223972131421'
====================================================================
+/tmp/viash_test_combine_plots5052818223972131421/build_executable/combine_plots ---setup
...
====================================================================
+/tmp/viash_test_combine_plots5052818223972131421/test_run_test.sh/run_test.sh
...
frame=    9 fps=0.0 q=0.0 Lsize=      13kB time=00:00:08.00 bitrate=  13.2kbits/s speed=12.2x    
...
> viash ns test -p docker --parallel --tsv /tmp/report.tsv
  ...
  civ6_save_renderer        combine_plots               docker          run_test.sh         0        5              SUCCESS
  civ6_save_renderer         convert_plot               docker     build_executable         0       16              SUCCESS
