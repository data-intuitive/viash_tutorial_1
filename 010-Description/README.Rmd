...
* First, we configure Civilization VI such that it creates an autosave of the current progress at each turn in the game. 
* For every save, we extract various pieces of information using two JavaScript scripts.
* We combine this information in R and render a visualisation of the world map as a PDF.
...
Some (actually, a lot) of code was omitted from the above script, for the purposes of this tutorial. You can view the full script at the [viash_docs](https://github.com/data-intuitive/viash_docs/blob/master/examples/civ6_postgame/src/civ6_save_renderer/plot_map/script.R) GitHub repository.
