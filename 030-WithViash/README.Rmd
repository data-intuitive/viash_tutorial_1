...
Let us see if we can shortcut some of this work using [viash], but first with some generic examples..
...
This _builds_ an _executable_ (script) `bin/silly_example2` that contains all the functionality that we saw in the above examples. Just to give two examples:
