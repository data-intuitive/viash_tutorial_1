...
The help from the last `silly_example3` does not show a lot of useful information. Let's some documentation regarding the component and its parameters.

```{sh}
cat src/silly_example4.vsh.yaml
```
